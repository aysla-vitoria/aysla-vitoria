# Olá, eu sou a Aysla Vitória! 👋

**Desenvolvedora de Software | Especialista em Análise e Desenvolvimento de Sistemas**

Apaixonada por resolver problemas através da programação e por fortalecer a segurança de ecossistemas digitais. Com formação concluída em **ADS**, busco constantemente unir o desenvolvimento robusto em Java com estratégias de segurança ofensiva e defensiva.

---

### 🚀 Sobre mim:
- 🎓 **Graduada em Análise e Desenvolvimento de Sistemas** pela Estácio de Sá.
- 🔭 Atualmente trabalhando em: Projetos de automação de segurança e auditoria web.
- 💻 Foco principal: Desenvolvimento Backend com **Java**, scripts de automação em **Python** e gestão de **Bancos de Dados SQL**.
- 👯 Liderança: Administradora da comunidade **CYBERDIMENSION**.
- ⚡ Curiosidade: Entusiasta de treinos de força e hipertrofia. 🏋️‍♀️
